		...
		if (isValidUser) {
			...
			if (userCreated) {
				...
				case "Director":
					...
					cuerpoCorreo = "Hola " + names
							+ "te has registrado como Director de escuadra.\nPor favor inicia sesión en la aplicación";

					if (correo.createEmail(newDirector.getEmail(), "Registro exitodo " + names, cuerpoCorreo)) {
						System.out.println("TODO FINE MI SOCIOOOO");
						correo.sendEmail();
					}
				...
				case "Masajista":
					...
					cuerpoCorreo = "Hola " + names
							+ "te has registrado como MAsajista.\nPor favor inicia sesión en la aplicación";
				...
				case "Ciclista":
					...
					if (correo.createEmail(newCyclist.getEmail(), "Registro exitodo " + names, cuerpoCorreo)) {
						System.out.println("TODO FINE MI SOCIOOOO");
						correo.sendEmail();
					}
