...
public class RegistrationForm extends JPanel {
	...
	public void insertMainContent() {
		...
		signUpButton = new ButtonGeneral("Registrarse", "Form_SignUp", ColorPalette.getMainRed(),
				ColorPalette.getMainWhite());
		signUpButton.setAlignmentX(Component.CENTER_ALIGNMENT);

		signInButton = new ButtonGeneral("Iniciar Sesión", "Form_SignIn", ColorPalette.getMainBlack(),
				ColorPalette.getMainWhite());
